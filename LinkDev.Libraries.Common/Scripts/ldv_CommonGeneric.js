...
function LoadRichEditor(fieldName, suffix, callback)
{
	...
	///     Author: Ahmed el-Sawalhy, Tarek Selem
	/// </summary>
...
function Remove(array, keyOrEvaluator, value, count)
{
	...
	///     Author: Ahmed el-Sawalhy, credit: http://stackoverflow.com/a/5767357/1919456
	/// </summary>
	/// <param name="array" type="object[]" optional="false"></param>
...
function Copy(obj, isDeep)
{
	...
	///     Author: Ahmed el-Sawalhy, credit: http://stackoverflow.com/a/23536726/1919456
	/// </summary>
