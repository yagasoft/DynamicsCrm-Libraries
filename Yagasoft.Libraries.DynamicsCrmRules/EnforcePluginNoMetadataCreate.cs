...
{
	internal sealed class EnforcePluginNoMetadataCreate : BaseFxCopRule
	{
		public override TargetVisibilities TargetVisibility => TargetVisibilities.All;

		public EnforcePluginNoMetadataCreate() : base("EnforcePluginNoMetadataCreate")
		{
			...
			if (construct != null)
			{
				var metadataCreateMessages =
					new[]
					{
						...
						"Microsoft.Xrm.Sdk.Messages.CreateOptionSetRequest"
					};
