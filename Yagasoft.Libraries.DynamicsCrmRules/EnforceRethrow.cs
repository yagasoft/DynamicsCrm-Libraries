...
{
	internal sealed class EnforceRethrow : BaseFxCopRule
	{
		public override TargetVisibilities TargetVisibility => TargetVisibilities.All;

		public EnforceRethrow() : base("EnforceRethrow")
		{
		...
		private bool IsContainsThrow(Block block)
		{
			...
			return block.Statements.Any(s => new[] {NodeType.Throw}.Contains(s.NodeType))
